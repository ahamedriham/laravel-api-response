...
namespace Taxionus\ResponseBuilder\Tests\Traits;
...
use Taxionus\ResponseBuilder\Builder;
...
trait TestingHelpers
{
                                             ...
                                             string $expected_message = null): \stdClass
    {
        ...
        if ($expected_message === null) {
            $key = \Taxionus\ResponseBuilder\BaseApiCodes::getCodeMessageKey($expected_api_code_offset);
            $key = $key ?? \Taxionus\ResponseBuilder\BaseApiCodes::getCodeMessageKey(
                    \Taxionus\ResponseBuilder\BaseApiCodes::OK());
            /** @var string $key */
     ...
     * \Taxionus\ResponseBuilder\ApiCodeBase::XXX constant name of expected and current values
     *
    ...
    {
        /** @var \Taxionus\ResponseBuilder\BaseApiCodes $api_codes_class_name */
        $api_codes_class_name = $this->getApiCodesClassName();
