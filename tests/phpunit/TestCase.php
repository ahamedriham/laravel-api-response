...
namespace Taxionus\ResponseBuilder\Tests;
...
abstract class TestCase extends \Orchestra\Testbench\TestCase
{
	...
	{
		return \Taxionus\ResponseBuilder\BaseApiCodes::class;
	}
	...
	{
		return [
			\Taxionus\ResponseBuilder\ResponseBuilderServiceProvider::class,
		];
	}
}
