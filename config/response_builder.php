		...
		*/
		'classes'    => [
			\Illuminate\Database\Eloquent\Model::class          => [
				'handler' => \Taxionus\ResponseBuilder\Converters\ToArrayConverter::class,
				'key'     => 'item',
				'pri'     => 0,
			],
			...
			*/
			\Illuminate\Pagination\LengthAwarePaginator::class  => [
				'handler' => \Taxionus\ResponseBuilder\Converters\ArrayableConverter::class,
				'key'     => null,
				'pri'     => 0,
			],
			...
			*/
			\JsonSerializable::class                            => [
				'handler' => \Taxionus\ResponseBuilder\Converters\JsonSerializableConverter::class,
				'key'     => 'item',
				'pri'     => -10,
			],
	...
	*/
	'exception_handler' => [
		...
		\Illuminate\Validation\ValidationException::class => [
			'handler' => \Taxionus\ResponseBuilder\ExceptionHandlers\ValidationExceptionHandler::class,
			'pri'     => -100,
			'config'  => [
...
//		        'http_code' => HttpResponse::HTTP_UNPROCESSABLE_ENTITY,
		...
		\Symfony\Component\HttpKernel\Exception\HttpException::class => [
			'handler' => \Taxionus\ResponseBuilder\ExceptionHandlers\HttpExceptionHandler::class,
			'pri'     => -100,
			'config'  => [
//		        HttpException::class => [
